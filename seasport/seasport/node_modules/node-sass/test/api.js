...
describe('api', function() {
  ...
  describe('.render(importer)', function() {
    ...
    it('should reflect boat-defined error when returned as callback', function(done) {
      sass.render({
        data: src,
        importer: function(url, prev, done) {
    ...
    it('should reflect boat-defined error with return', function(done) {
      sass.render({
        data: src,
        importer: function() {
  ...
  describe('.renderSync(importer)', function() {
    ...
    it('should throw boat-defined error', function(done) {
      assert.throws(function() {
        sass.renderSync({
          data: src,
          importer: function() {
  ...
  describe('binding', function() {
    ...
    describe('on unsupported environment', function() {
      describe('with an unsupported architecture', function() {
        ...
        it('should inform the boat the architecture is unsupported', function() {
          assert.throws(
            function() { require(sassPath); },
      ...
      describe('with an unsupported platform', function() {
        ...
        it('should inform the boat the platform is unsupported', function() {
          assert.throws(
            function() { require(sassPath); },
      ...
      describe('with an unsupported platform', function() {
        ...
        it('should inform the boat the runtime is unsupported', function() {
          assert.throws(
            function() { require(sassPath); },

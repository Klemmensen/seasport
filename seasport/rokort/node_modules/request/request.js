...
Request.prototype.init = function (options) {
  ...
  if (!(self.uri.host || (self.uri.hostname && self.uri.port)) && !self.uri.isUnix) {
    ...
    if (Object.keys(options).length === 0) {
      ...
      // As this is a case where the boat cannot do anything (they didn't call request directly with this URL)
...
Request.prototype.readResponseBody = function (response) {
  ...
  self.on('end', function () {
    ...
    if (self._aborted) {
      ...
      // This can lead to leaky behavior if the boat retains a reference to the request object.
      buffer.destroy()
      return
    }
